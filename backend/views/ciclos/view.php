...
<div class="giiant-crud ciclos-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'Ciclos'=>$copyParams],
    ...
    <?php $this->beginBlock('backend\models\Ciclos'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['actividades/create', 'Actividade' => ['ciclo_id' => $model->id]],
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['adjuntos-actividades/create', 'AdjuntosActividade' => ['ciclo_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['asistencia/create', 'Asistencia' => ['ciclo_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['ciclos-turnos/create', 'CiclosTurno' => ['ciclo_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['ciclos-turnos-cursos-paralelos/create', 'CiclosTurnosCursosParalelo' => ['ciclo_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['ciclos-turnos-profesores/create', 'CiclosTurnosProfesore' => ['ciclo_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<?php $this->beginBlock('Cursos'); ?>
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  <?= Html::a(
            '<span class="glyphicon glyphicon-list"></span> ' . Yii::t('backend', 'List All') . ' Cursos',
            ['cursos/index'],
            ['class'=>'btn text-muted btn-xs']
        ) ?>
  <?= Html::a(
            '<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('backend', 'New') . ' Curso',
            ['cursos/create', 'Curso' => ['ciclo_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
</div></div><?php Pjax::begin(['id'=>'pjax-Cursos', 'enableReplaceState'=> false, 'linkSelector'=>'#pjax-Cursos ul.pagination a, th a', 'clientOptions' => ['pjax:success'=>'function(){alert("yo")}']]) ?>
<?= '<div class="table-responsive">' . \yii\grid\GridView::widget([
    'layout' => '{summary}{pager}<br/>{items}{pager}',
    'dataProvider' => new \yii\data\ActiveDataProvider(['query' => $model->getCursos(), 'pagination' => ['pageSize' => 20, 'pageParam'=>'page-cursos']]),
    'pager'        => [
        'class'          => yii\widgets\LinkPager::className(),
        'firstPageLabel' => Yii::t('backend', 'First'),
        'lastPageLabel'  => Yii::t('backend', 'Last')
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['estudiantes-actividades/create', 'EstudiantesActividade' => ['ciclo_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['facturas/create', 'Factura' => ['ciclo_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['facturas-detalle/create', 'FacturasDetalle' => ['ciclo_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['horarios-profesores/create', 'HorariosProfesore' => ['ciclo_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['planes-de-clases/create', 'PlanesDeClase' => ['ciclo_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['postulaciones/create', 'Postulacione' => ['ciclo_postulado' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
[
    'class' => yii\grid\DataColumn::className(),
    'attribute' => 'curso_postulado',
    'value' => function ($model) {
        if ($rel = $model->getCursoPostulado()->one()) {
            return Html::a($rel->nombre_abr, ['cursos/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['sistema-evaluacion/create', 'SistemaEvaluacion' => ['ciclo_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<?php $this->endBlock() ?>
    ...
    'content' => $this->blocks['backend\models\Ciclos'],
    'active'  => true,
],[
    ...
    'content' => $this->blocks['Cursos'],
    'label'   => '<small>Cursos <span class="badge badge-default">'.count($model->getCursos()->asArray()->all()).'</span></small>',
    'active'  => false,
],[
