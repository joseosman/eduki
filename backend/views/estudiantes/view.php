...
[
    ...
    'value' => ($model->getReligion()->one() ? Html::a($model->getReligion()->one()->nombre, ['religiones/view', 'id' => $model->getReligion()->one()->id,]) : '<span class="label label-warning">?</span>'),
],
        'rude',
// generated by schmunk42\giiant\generators\crud\providers\RelationProvider::attributeFormat
[
    'format' => 'html',
    'attribute' => 'curso_id',
    'value' => ($model->getCurso()->one() ? Html::a($model->getCurso()->one()->nombre, ['cursos/view', 'id' => $model->getCurso()->one()->id,]) : '<span class="label label-warning">?</span>'),
],
    ],
    ]); ?>
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->getTipoBeca()->one()) {
            return Html::a($rel->nombre, ['tipo-becas/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->getBeca()->one()) {
            return Html::a($rel->nombre, ['becas/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->getTipoCuota()->one()) {
            return Html::a($rel->nombre, ['tipo-cuotas/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->getFrecuencia()->one()) {
            return Html::a($rel->nombre, ['frecuencia-cuotas/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->getPadre()->one()) {
            return Html::a($rel->fullnameinverted, ['padres/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->getIdioma()->one()) {
            return Html::a($rel->nombre, ['idiomas/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
...
[
    ...
    'value' => function ($model) {
        if ($rel = $model->getTransporte()->one()) {
            return Html::a($rel->nombre, ['transporte/view', 'id' => $rel->id,], ['data-pjax' => 0]);
        } else {
            return '';
        }
    },
