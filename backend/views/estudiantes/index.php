...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\models\EstudiantesSearch $searchModel
*/
...
?>
<div class="giiant-crud estudiantes-index">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            'items' => [            [
                ...
                'url' => ['becas/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('backend', 'Becas') . '</i>',
            ],            [
                'url' => ['becas-detalle/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('backend', 'Becas Detalle') . '</i>',
            ],            [
                'url' => ['cuotas/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('backend', 'Cuotas') . '</i>',
            ],            [
                'url' => ['cursos/index'],
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('backend', 'Religiones') . '</i>',
            ],            [
                ...
                'url' => ['hijos/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('backend', 'Hijos') . '</i>',
            ],            [
                'url' => ['historial-medico/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('backend', 'Historial Medico') . '</i>',
            ],            [
                'url' => ['idiomas-estudiantes/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('backend', 'Idiomas Estudiantes') . '</i>',
            ],            [
                ...
                'url' => ['transporte-detalle/index'],
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('backend', 'Transporte Detalle') . '</i>',
            ],]
            ],
            'options' => [
            'class' => 'btn-default'
    ...
    <div class="table-responsive">
        ...
        'columns' => [
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->getTipoDoc()->one()) {
			            return Html::a($rel->id, ['tipo-documentos/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->getEstado()->one()) {
			            return Html::a($rel->id, ['estados/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->getReligion()->one()) {
			            return Html::a($rel->id, ['religiones/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
