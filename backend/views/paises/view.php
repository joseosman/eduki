...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['administrativos/create', 'Administrativo' => ['pais_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['choferes/create', 'Chofere' => ['pais_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['estudiantes/create', 'Estudiante' => ['pais_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['padres/create', 'Padre' => ['pais_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['profesores/create', 'Profesore' => ['pais_id' => $model->id]],
            ['class'=>'btn btn-success btn-xs']
        ); ?>
