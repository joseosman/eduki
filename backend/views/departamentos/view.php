...
<div class="giiant-crud departamentos-view">
    ...
    <?php $this->beginBlock('backend\models\Departamentos'); ?>
...
[
    'format' => 'html',
    'attribute' => 'jefe_admin_id',
    'value' => (Administrativos::find()->where(['id' => $model->jefe_admin_id])->one() ? Html::a(Administrativos::find()->where(['id' => $model->jefe_admin_id])->one()->fullnameinverted, ['administrativos/view', 'id' => Administrativos::find()->where(['id' => $model->jefe_admin_id])->one()->id,]) : '<span class="label label-warning">?</span>'),
],
    ],
    ]); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['administrativos/create', 'Administrativo' => ['departamento_id' => $model->id]],
...
<?php $this->endBlock() ?>
    ...
    'content' => $this->blocks['backend\models\Departamentos'],
    'active'  => true,
],[
