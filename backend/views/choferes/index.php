...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var backend\models\ChoferesSearch $searchModel
*/
...
?>
<div class="giiant-crud choferes-index">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class="pull-right">
            ...
            'items' => [            [
                ...
                'label' => '<i class="glyphicon glyphicon-arrow-right">&nbsp;' . Yii::t('backend', 'Transporte') . '</i>',
            ],]
            ],
            'options' => [
            'class' => 'btn-default'
