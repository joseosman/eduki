...
{
return [
[['id', 'pais_id', 'estado_id', 'user_id', 'tipo_doc_id', 'religion_id', 'curso_id', 'created_at', 'created_by', 'updated_at', 'updated_by', 'deleted'], 'integer'],
            [['nombres', 'ap_pat', 'ap_mat', 'fec_nac', 'sex', 'ruta_foto', 'tipo_sangre', 'email', 'tel_fijo', 'tel_movil', 'tel_emergencia', 'contacto_emergencia', 'num_doc_id', 'direcc', 'fec_insc', 'rude'], 'safe'],
];
}
...
$query->andFilterWhere([
        ...
        $query->andFilterWhere(['like', 'nombres', $this->nombres])
            ...
            ->andFilterWhere(['like', 'direcc', $this->direcc])
