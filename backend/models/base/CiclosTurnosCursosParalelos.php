...
/**
 * This is the base-model class for table "ciclos_turnos_cursos_paralelos".
 *
 * @property integer $id
 ...
 */
abstract class CiclosTurnosCursosParalelos extends \yii\db\ActiveRecord
{
    ...
    {
        return 'ciclos_turnos_cursos_paralelos';
    }
    ...
    {
        return [
            [['ciclo_id', 'turno_id', 'curso_id', 'paralelo_id'], 'required'],
            [['ciclo_id', 'turno_id', 'curso_id', 'paralelo_id', 'deleted'], 'integer'],
