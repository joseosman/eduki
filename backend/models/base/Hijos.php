...
/**
 * This is the base-model class for table "hijos".
 *
 * @property string $id
 ...
 * @property \backend\models\Padres $padre
 * @property string $aliasModel
 */
abstract class Hijos extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['padre_id', 'estudiante_id'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('backend', 'ID'),
            'padre_id' => Yii::t('backend', 'Padre ID'),
    ...
    {
        return $this->hasOne(\backend\models\Padres::className(), ['id' => 'padre_id']);
    }
