...
/**
 * This is the base-model class for table "adjuntos_actividades".
 *
 * @property string $id
 ...
 * @property string $estudiante_actividad_id
 ...
 *
 * @property \backend\models\EstudiantesActividades $estudianteActividad
 ...
 */
abstract class AdjuntosActividades extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ciclo_id', 'turno_id', 'curso_id', 'materia_id', 'profesor_id', 'tipo_id', 'bimestre_id', 'actividad_id', 'estudiante_id', 'estudiante_actividad_id', 'ruta_adjunto'], 'required'],
            [['ciclo_id', 'turno_id', 'curso_id', 'materia_id', 'profesor_id', 'tipo_id', 'bimestre_id', 'actividad_id', 'estudiante_id', 'estudiante_actividad_id', 'deleted'], 'integer'],
            [['ruta_adjunto'], 'string', 'max' => 2000],
            [['estudiante_actividad_id'], 'exist', 'skipOnError' => true, 'targetClass' => EstudiantesActividades::className(), 'targetAttribute' => ['estudiante_actividad_id' => 'id']],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'estudiante_actividad_id' => Yii::t('backend', 'Estudiante Actividad ID'),
     ...
     */
    public function getEstudianteActividad()
    {
        return $this->hasOne(\backend\models\EstudiantesActividades::className(), ['id' => 'estudiante_actividad_id']);
    }
