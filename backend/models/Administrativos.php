...
use Yii;
use \backend\models\base\Administrativos as BaseAdministrativos;
...
class Administrativos extends BaseAdministrativos
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'departamento_id' => Yii::t('backend', 'Departamento'),
            'cargo_id' => Yii::t('backend', 'Cargo'),
            'nombre_afp' => Yii::t('backend', 'Nombre Afp'),
            'numero_afp' => Yii::t('backend', 'Número Afp'),
