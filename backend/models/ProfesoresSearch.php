...
[['id', 'pais_id', 'estado_id', 'user_id', 'tipo_doc_id', 'active', 'created_at', 'created_by', 'updated_at', 'updated_by', 'deleted'], 'integer'],
            [['nombres', 'ap_pat', 'ap_mat', 'fec_nac', 'sex', 'ruta_foto', 'tipo_sangre', 'email', 'tel_fijo', 'tel_movil', 'tel_emergencia', 'contacto_emergencia', 'num_doc_id', 'direc', 'fec_ini', 'email_trabajo', 'tel_fijo_trabajo', 'tel_movil_trabajo', 'aula_oficina', 'nombre_afp', 'num_de_afp'], 'safe'],
];
}
...
$query->andFilterWhere([
        ...
        $query->andFilterWhere(['like', 'nombres', $this->nombres])
            ...
            ->andFilterWhere(['like', 'aula_oficina', $this->aula_oficina])
            ->andFilterWhere(['like', 'nombre_afp', $this->nombre_afp])
            ->andFilterWhere(['like', 'num_de_afp', $this->num_de_afp]);
