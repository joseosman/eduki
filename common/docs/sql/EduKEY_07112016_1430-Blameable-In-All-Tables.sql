...
ALTER TABLE `estudiantes` ADD CONSTRAINT `estudiantes_fk0` FOREIGN KEY (`persona_id`) REFERENCES `personas`(`id`);
...
ALTER TABLE `administrativos` ADD CONSTRAINT `administrativos_fk0` FOREIGN KEY (`persona_id`) REFERENCES `personas`(`id`);
...
ALTER TABLE `profesores` ADD CONSTRAINT `profesores_fk0` FOREIGN KEY (`persona_id`) REFERENCES `personas`(`id`);

ALTER TABLE `padres` ADD CONSTRAINT `padres_fk0` FOREIGN KEY (`persona_id`) REFERENCES `personas`(`id`);

ALTER TABLE `idiomas_estudiantes` ADD CONSTRAINT `idiomas_estudiantes_fk0` FOREIGN KEY (`idioma_id`) REFERENCES `idiomas`(`id`);

ALTER TABLE `idiomas_estudiantes` ADD CONSTRAINT `idiomas_estudiantes_fk1` FOREIGN KEY (`estudiante_id`) REFERENCES `estudiantes`(`persona_id`);
...
ALTER TABLE `actividades` ADD CONSTRAINT `actividades_fk1` FOREIGN KEY (`curso_id`) REFERENCES `cursos`(`id`);

ALTER TABLE `actividades` ADD CONSTRAINT `actividades_fk2` FOREIGN KEY (`materia_id`) REFERENCES `materias`(`id`);

ALTER TABLE `actividades` ADD CONSTRAINT `actividades_fk3` FOREIGN KEY (`profesor_id`) REFERENCES `profesores`(`id`);

ALTER TABLE `actividades` ADD CONSTRAINT `actividades_fk4` FOREIGN KEY (`tipo_id`) REFERENCES `tipos_actividades`(`id`);

ALTER TABLE `actividades` ADD CONSTRAINT `actividades_fk5` FOREIGN KEY (`bimestre_id`) REFERENCES `bimestres`(`id`);

ALTER TABLE `ponderacion_actividades` ADD CONSTRAINT `ponderacion_actividades_fk0` FOREIGN KEY (`ciclo_id`) REFERENCES `ciclos`(`id`);

ALTER TABLE `ponderacion_actividades` ADD CONSTRAINT `ponderacion_actividades_fk1` FOREIGN KEY (`curso_id`) REFERENCES `cursos`(`id`);

ALTER TABLE `ponderacion_actividades` ADD CONSTRAINT `ponderacion_actividades_fk2` FOREIGN KEY (`materia_id`) REFERENCES `materias`(`id`);

ALTER TABLE `ponderacion_actividades` ADD CONSTRAINT `ponderacion_actividades_fk3` FOREIGN KEY (`profesor_id`) REFERENCES `profesores`(`id`);

ALTER TABLE `ponderacion_actividades` ADD CONSTRAINT `ponderacion_actividades_fk4` FOREIGN KEY (`tipo_id`) REFERENCES `tipos_actividades`(`id`);

ALTER TABLE `estudiantes_actividades` ADD CONSTRAINT `estudiantes_actividades_fk0` FOREIGN KEY (`ciclo_id`) REFERENCES `ciclos`(`id`);

ALTER TABLE `estudiantes_actividades` ADD CONSTRAINT `estudiantes_actividades_fk1` FOREIGN KEY (`curso_id`) REFERENCES `cursos`(`id`);

ALTER TABLE `estudiantes_actividades` ADD CONSTRAINT `estudiantes_actividades_fk2` FOREIGN KEY (`materia_id`) REFERENCES `materias`(`id`);

ALTER TABLE `estudiantes_actividades` ADD CONSTRAINT `estudiantes_actividades_fk3` FOREIGN KEY (`profesor_id`) REFERENCES `profesores`(`id`);

ALTER TABLE `estudiantes_actividades` ADD CONSTRAINT `estudiantes_actividades_fk4` FOREIGN KEY (`tipo_id`) REFERENCES `tipos_actividades`(`id`);

ALTER TABLE `estudiantes_actividades` ADD CONSTRAINT `estudiantes_actividades_fk5` FOREIGN KEY (`bimestre_id`) REFERENCES `bimestres`(`id`);

ALTER TABLE `estudiantes_actividades` ADD CONSTRAINT `estudiantes_actividades_fk6` FOREIGN KEY (`actividad_id`) REFERENCES `actividades`(`id`);

ALTER TABLE `estudiantes_actividades` ADD CONSTRAINT `estudiantes_actividades_fk7` FOREIGN KEY (`estudiante_id`) REFERENCES `estudiantes`(`id`);

ALTER TABLE `adjuntos_actividades` ADD CONSTRAINT `adjuntos_actividades_fk0` FOREIGN KEY (`ciclo_id`) REFERENCES `ciclos`(`id`);

ALTER TABLE `adjuntos_actividades` ADD CONSTRAINT `adjuntos_actividades_fk1` FOREIGN KEY (`curso_id`) REFERENCES `cursos`(`id`);

ALTER TABLE `adjuntos_actividades` ADD CONSTRAINT `adjuntos_actividades_fk2` FOREIGN KEY (`materia_id`) REFERENCES `materias`(`id`);

ALTER TABLE `adjuntos_actividades` ADD CONSTRAINT `adjuntos_actividades_fk3` FOREIGN KEY (`profesor_id`) REFERENCES `profesores`(`id`);

ALTER TABLE `adjuntos_actividades` ADD CONSTRAINT `adjuntos_actividades_fk4` FOREIGN KEY (`tipo_id`) REFERENCES `tipos_actividades`(`id`);

ALTER TABLE `adjuntos_actividades` ADD CONSTRAINT `adjuntos_actividades_fk5` FOREIGN KEY (`bimestre_id`) REFERENCES `bimestres`(`id`);

ALTER TABLE `adjuntos_actividades` ADD CONSTRAINT `adjuntos_actividades_fk6` FOREIGN KEY (`actividad_id`) REFERENCES `actividades`(`id`);

ALTER TABLE `adjuntos_actividades` ADD CONSTRAINT `adjuntos_actividades_fk7` FOREIGN KEY (`estudiante_id`) REFERENCES `estudiantes`(`id`);

ALTER TABLE `horarios_profesores` ADD CONSTRAINT `horarios_profesores_fk0` FOREIGN KEY (`ciclo_id`) REFERENCES `ciclos`(`id`);

ALTER TABLE `horarios_profesores` ADD CONSTRAINT `horarios_profesores_fk1` FOREIGN KEY (`curso_id`) REFERENCES `cursos`(`id`);

ALTER TABLE `horarios_profesores` ADD CONSTRAINT `horarios_profesores_fk2` FOREIGN KEY (`materia_id`) REFERENCES `materias`(`id`);

ALTER TABLE `horarios_profesores` ADD CONSTRAINT `horarios_profesores_fk3` FOREIGN KEY (`profesor_id`) REFERENCES `profesores`(`id`);
...
ALTER TABLE `planes_de_clases` ADD CONSTRAINT `planes_de_clases_fk2` FOREIGN KEY (`curso_id`) REFERENCES `cursos`(`id`);

ALTER TABLE `planes_de_clases` ADD CONSTRAINT `planes_de_clases_fk3` FOREIGN KEY (`paralelo_id`) REFERENCES `paralelos`(`id`);

ALTER TABLE `planes_de_clases` ADD CONSTRAINT `planes_de_clases_fk4` FOREIGN KEY (`materia_id`) REFERENCES `materias`(`id`);

ALTER TABLE `asistencia` ADD CONSTRAINT `asistencia_fk0` FOREIGN KEY (`ciclo_id`) REFERENCES `ciclos`(`id`);

ALTER TABLE `asistencia` ADD CONSTRAINT `asistencia_fk1` FOREIGN KEY (`curso_id`) REFERENCES `cursos`(`id`);

ALTER TABLE `asistencia` ADD CONSTRAINT `asistencia_fk2` FOREIGN KEY (`materia_id`) REFERENCES `materias`(`id`);

ALTER TABLE `asistencia` ADD CONSTRAINT `asistencia_fk3` FOREIGN KEY (`periodo_id`) REFERENCES `periodos`(`id`);

ALTER TABLE `asistencia` ADD CONSTRAINT `asistencia_fk4` FOREIGN KEY (`profesor_id`) REFERENCES `profesores`(`id`);

ALTER TABLE `asistencia` ADD CONSTRAINT `asistencia_fk5` FOREIGN KEY (`estudiante_id`) REFERENCES `estudiantes`(`id`);

ALTER TABLE `asistencia` ADD CONSTRAINT `asistencia_fk6` FOREIGN KEY (`estado_id`) REFERENCES `estado_asistencia`(`id`);

ALTER TABLE `asistencia` ADD CONSTRAINT `asistencia_fk7` FOREIGN KEY (`bimestre_id`) REFERENCES `bimestres`(`id`);
...
ALTER TABLE `personas` ADD CONSTRAINT `personas_fk2` FOREIGN KEY (`user_id`) REFERENCES `user`(`id`);
...
ALTER TABLE `becas` ADD CONSTRAINT `becas_fk1` FOREIGN KEY (`tipo_beca_id`) REFERENCES `tipos_becas`(`id`);
...
ALTER TABLE `becas_detalle` ADD CONSTRAINT `becas_detalle_fk2` FOREIGN KEY (`tipo_beca_id`) REFERENCES `tipos_becas`(`id`);
...
ALTER TABLE `facturas_detalle` ADD CONSTRAINT `facturas_detalle_fk3` FOREIGN KEY (`curso_id`) REFERENCES `cursos`(`id`);

ALTER TABLE `facturas_detalle` ADD CONSTRAINT `facturas_detalle_fk4` FOREIGN KEY (`paralelo_id`) REFERENCES `paralelos`(`id`);

ALTER TABLE `facturas_detalle` ADD CONSTRAINT `facturas_detalle_fk5` FOREIGN KEY (`cuota_id`) REFERENCES `cuotas`(`id`);

ALTER TABLE `choferes` ADD CONSTRAINT `choferes_fk0` FOREIGN KEY (`persona_id`) REFERENCES `personas`(`id`);
