...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-07-2016 a las 01:42:12
...
(1, 'Cambridge College', '', 'Carretera al Norte, Km 8 1/2', '33333333', 'cc@cambridge.edu', 1468418296, 1, 1468418296, 1, 0);
...
CREATE TABLE IF NOT EXISTS `libros_prestamos` (
  ...
  `multa_pagada` tinyint(1) NOT NULL,
  `created_at` int(11) NOT NULL,
  `created_by` int(11) NOT NULL,
  `updated_at` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `tipos_medidas_disciplinarias`
--

CREATE TABLE IF NOT EXISTS `tipos_medidas_disciplinarias` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(60) NOT NULL,
  `created_at` int(11) NOT NULL,
  `created_by` int(11) NOT NULL,
...
ALTER TABLE `actividades`
  ...
  ADD CONSTRAINT `actividades_fk4` FOREIGN KEY (`tipo_id`) REFERENCES `tipos_actividades` (`id`);
...
ALTER TABLE `adjuntos_actividades`
  ...
  ADD CONSTRAINT `adjuntos_actividades_fk4` FOREIGN KEY (`tipo_id`) REFERENCES `tipos_actividades` (`id`),
...
--
ALTER TABLE `becas`
  ADD CONSTRAINT `becas_fk1` FOREIGN KEY (`tipo_beca_id`) REFERENCES `tipos_becas` (`id`),
...
ALTER TABLE `becas_detalle`
  ...
  ADD CONSTRAINT `becas_detalle_fk2` FOREIGN KEY (`tipo_beca_id`) REFERENCES `tipos_becas` (`id`);
...
ALTER TABLE `estudiantes_actividades`
  ...
  ADD CONSTRAINT `estudiantes_actividades_fk4` FOREIGN KEY (`tipo_id`) REFERENCES `tipos_actividades` (`id`),
...
ALTER TABLE `medidas_disciplinarias_tomadas`
  ADD CONSTRAINT `medidas_disciplinarias_tomadas_fk1` FOREIGN KEY (`tipo_medida_id`) REFERENCES `tipos_medidas_disciplinarias` (`id`),
...
ALTER TABLE `ponderacion_actividades`
  ADD CONSTRAINT `ponderacion_actividades_fk4` FOREIGN KEY (`tipo_id`) REFERENCES `tipos_actividades` (`id`),
