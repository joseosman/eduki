...
ALTER TABLE `asignacion_materias` ADD CONSTRAINT `asignacion_materias_fk0` FOREIGN KEY (`mat_id`) REFERENCES `materias`(`mat_id`);

ALTER TABLE `asignacion_materias` ADD CONSTRAINT `asignacion_materias_fk1` FOREIGN KEY (`pro_id`) REFERENCES `profesores`(`pro_id`);

ALTER TABLE `asignacion_materias` ADD CONSTRAINT `asignacion_materias_fk2` FOREIGN KEY (`cur_id`) REFERENCES `cursos`(`cur_id`);
