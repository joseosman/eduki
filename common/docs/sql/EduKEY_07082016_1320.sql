...
CREATE TABLE `postulantes_admision` (
...
ALTER TABLE `horarios_profesores` ADD CONSTRAINT `horarios_profesores_fk0` FOREIGN KEY (`pro_id`) REFERENCES `profesores`(`id`);

ALTER TABLE `horarios_profesores` ADD CONSTRAINT `horarios_profesores_fk1` FOREIGN KEY (`cur_id`) REFERENCES `cursos`(`id`);

ALTER TABLE `horarios_profesores` ADD CONSTRAINT `horarios_profesores_fk2` FOREIGN KEY (`mat_id`) REFERENCES `materias`(`id`);
